...
namespace RealEstate_Dapper_Api.Repositories.EmployeeRepositories
{
    public class EmployeeRepository : IEmployeeRepository
    {
        ...
        {
            string query = "insert into Employee (Name,Title,Mail,PhoneNumber,ImgUrl,Status) values (@name,@title,@mail,@phoneNumber,@imageUrl,@status)";
            ...
            parameters.Add("@imageUrl", createEmployeeDto.ImgUrl);
        ...
        {
            string query = "Update Employee Set Name=@name,Title=@title,Mail=@mail,PhoneNumber=@phoneNumber,ImgUrl=@imageUrl,Status=@status where EmployeeID=@employeeId";
            var parameters = new DynamicParameters();
            parameters.Add("@name", updateEmployeeDto.Name);
            parameters.Add("@title", updateEmployeeDto.Title);
            parameters.Add("@mail", updateEmployeeDto.Mail);
            parameters.Add("@phoneNumber", updateEmployeeDto.PhoneNumber);
            parameters.Add("@imageUrl", updateEmployeeDto.ImgUrl);
