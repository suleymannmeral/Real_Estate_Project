...
namespace RealEstate_Dapper_Api.Tools
{
    public class JwtTokenGenerator
    {
        public static TokenResponseViewModel GenerateToken(GetCheckAppUserViewModel model)
        {
            ...
            JwtSecurityToken token = new JwtSecurityToken(issuer: JwtTokenDefaults.ValidUssuer, audience: JwtTokenDefaults.ValidAuidence, claims: claims, notBefore: DateTime.UtcNow, expires: expireDate, signingCredentials: signinCredentials);
